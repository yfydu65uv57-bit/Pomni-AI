...
const client = new Client({
  ...
  owners: [
  // Owner 1
    { name: "VA", lid: "247579682029763@lid", jid: "201213936427@s.whatsapp.net" },
  // Owner 2
    { name: "emam", lid: "221307316789354@lid", jid: "201213936427@s.whatsapp.net" },
  // Owner 3
    { name: "Sukuna", jid: "201213936427@s.whatsapp.net", lid: "50414477168824@lid" },
  // Owner 4 
   { name: "عمورتي", jid: "201213936427@s.whatsapp.net", lid: "51664513925368@lid" }
  ],
...
config.info = { 
  nameBot: "♡ 𝙋𝙊𝙈𝙉𝙄 🎪 〈", 
  nameChannel: "𝐕𝐈𝐈7 ~ ⟬𝑻𝑬𝑻𝑶(<𝑬𝑳͠>)𝑯𝒂𝑲𝒆𝑴⟭ 🕷️", 
